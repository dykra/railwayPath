...
SELECT 
	P.OBJECTID, CENTER_LAT, CENTER_LON, P.Improve_Curr_Value, P.LS1_Sale_Date, P.BD_LINE_1_Sq_Ft_of_Main_Improve, 
	Price_Per_Single_Area_Unit, Parcel_Area,Residential, Special_Purposes_Plan, Commercial, Manufacturing, 
